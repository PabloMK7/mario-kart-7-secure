...
replace github.com/PretendoNetwork/nex-protocols-common-go/v2 v2.0.3 => github.com/PabloMK7/nex-protocols-common-go/v2 v2.0.0-20240410201924-f0eba0b58444
