...
replace github.com/PretendoNetwork/nex-protocols-common-go/v2 v2.0.2 => github.com/PabloMK7/nex-protocols-common-go/v2 v2.0.0-20240410171831-6cb4f598e3e0
